...
if($_SERVER['REQUEST_METHOD'] === "POST"){
    ...
    if($flag === true){
        ...
        $sql = "Select * from `teacherstudent`.`student` WHERE  email='$emailUser' OR Username='$emailUser' AND password='$password' ";
        // $email $password
        ...
        <tr>
            ...
            <h1>Student Login Page</h1>
                ...
                <fieldset>
                    ...
                    <!-- ---------------------------------------- -->
                    <form action="studentlogin.php" method="post" novalidate>
                        <table>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td><p>Don't have an account?<a href="./studentregister.php">Register here</a></p></td>
                            </tr>
