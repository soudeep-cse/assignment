...
include './database.php';
    ...
    if($_SERVER['REQUEST_METHOD'] === "POST"){
        ...
        $errorfirstname=$errorlastname=$errorUsername=$erroremail=$errorpassword=$errorconfirmpassword=$errorvalidmail=$errormatchedpassword=" ";
        ...
        if($flag === true){
            ...
            if(!empty($firstname) && !empty($lastname) && !empty($email)&& !empty($password)&& !empty($confirmpassword)){
                if($password===$confirmpassword){
                    ...
                    $sql="select * from teacher where (email='$email' or Username='$Username');";
                    ...
                    if($row>0){
                        ...
                        if($email==$row['email']){
                            ...
                            $sql = "insert into teacher(firstname,lastname,Username, email, password) values('$firstname', '$lastname','$Username','$email','$password')";
...
<form action="teacherregister.php" novalidate method="post" >
<div align="center">
    ...
    <tr>
        <td>
            ...
            <fieldset>
                ...
                <!-- ---------------------------------------- -->
                <form action="teacherregister.php" novalidate>
                    <table>
...
<div align="center">
<h4>Already Have an Accout?<a href="./teacherlogin.php">Login here</a></h4>
